...
export default {
    ...
    methods: {
        async save() {
            ...
            try {
                if (this.isEditing) {
                    await PlateTypeService.update(this.entity);
                } else {
                    await PlateTypeService.store(this.entity);
                }
        ...
        async destroy() {
            ...
            this.loading = true;
            try {
                await PlateTypeService.destroy(this.entity.id);
                window.location.reload();
            } catch (error) {
        ...
        initDataTable() {
            ...
            const options = {
                apiEndpoint: PlateTypeService.getUrl(),
                requestHeaders: {
