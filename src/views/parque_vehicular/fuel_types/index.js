...
export default {
    ...
    methods: {
        async save() {
            ...
            try {
                if (this.isEditing) {
                    await FuelTypeService.update(this.entity);
                } else {
                    await FuelTypeService.store(this.entity);
                }
        ...
        async destroy() {
            ...
            this.loading = true;
            try {
                await FuelTypeService.destroy(this.entity.id);
                window.location.reload();
            } catch (error) {
        ...
        initDataTable() {
            ...
            const options = {
                apiEndpoint: FuelTypeService.getUrl(),
                requestHeaders: {
