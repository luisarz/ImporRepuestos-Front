...
export default {
    ...
    data() {
        return {
            loading: false,
            isEditing: false, // Nuevo flag para saber si estamos editando
            saleId: null, // ID de la venta que estamos editando
            warehouses: [],
            customers: [],
            sellers: [],
            documentTypes: [],
    ...
    `,
            ...
            try {
                ...
                try {
                    if (this.isEditing) {
                        this.sale_header.id = this.saleId;
                    } else {
                        // Crear nueva venta solo si no estamos editando
