      ...
      <div class="card-body">
        <div>
          <div class="scrollable-x-auto">
            <table id="#table_modulo" class="table" data-datatable-table="true">
              <thead>
              <tr>
                <th class="w-[150px] text-center" data-datatable-column="status">
                                        <span class="sort">
                ...
                <th class="w-[350px] text-center" data-datatable-column="status">
                                        <span class="sort">
                                            <span class="sort-label">
                                                Producto
                                            </span>
  ...
  <general-modal id="modal_store" :title="modalTitle">
    ...
    <template #footer>
      ...
      <button class="btn btn-primary" @click="save" :disabled="loading">
        {{ isEditing ? 'Modificar Marca' : 'Crear Marca' }}
      </button>
    </template>
  </general-modal>
