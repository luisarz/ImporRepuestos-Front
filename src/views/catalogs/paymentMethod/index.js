...
import PaymentMethodService from '@/services/hacienda/paymentMethodService.js';
...
export default {
    ...
    methods: {
        async save() {
            ...
            try {
                if (this.isEditing) {
                    await PaymentMethodService.update(this.entity);
                } else {
                    await PaymentMethodService.store(this.entity);
                }
        ...
        async destroy() {
            ...
            this.loading = true;
            try {
                await PaymentMethodService.destroy(this.entity.id);
                window.location.reload();
            } catch (error) {
        ...
        initDataTable() {
            ...
            const options = {
                apiEndpoint: PaymentMethodService.getUrl(),
                requestHeaders: {
