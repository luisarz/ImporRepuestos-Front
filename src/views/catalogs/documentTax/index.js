...
import documentTaxService from '@/services/hacienda/documentTaxService.js';
...
export default {
    ...
    methods: {
        async save() {
            ...
            try {
                if (this.isEditing) {
                    await documentTaxService.update(this.entity);
                } else {
                    await documentTaxService.store(this.entity);
                }
        ...
        async destroy() {
            ...
            this.loading = true;
            try {
                await documentTaxService.destroy(this.entity.id);
                window.location.reload();
            } catch (error) {
        ...
        initDataTable() {
            ...
            const options = {
                apiEndpoint: documentTaxService.getUrl(),
                requestHeaders: {
