<template>
  ...
  <general-modal id="modal_store" :title="modalTitle">
    <template #body>
      <input type="hidden" name="id" v-model="unitMeasurement.id"/>
      <div class="card">
              ...
              <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                ...
                <div class="flex flex-col w-full gap-1">
                  <input
                      ...
                      :type="field.type"
                      v-model="unitMeasurement[field.key]"
                  ...
                  <label v-else-if="field.type === 'checkbox'" class="switch">
                    <input type="checkbox" v-model="unitMeasurement[field.key]" :true-value="1" :false-value="0"/>
                  </label>
