...
import CountriesService from '@/services/hacienda/countriesActivityService.js';
...
export default {
    ...
    methods: {
        async save() {
            ...
            try {
                if (this.isEditing) {
                    await CountriesService.update(this.entity);
                } else {
                    await CountriesService.store(this.entity);
                }
        ...
        async destroy() {
            ...
            this.loading = true;
            try {
                await CountriesService.destroy(this.entity.id);
                window.location.reload();
            } catch (error) {
        ...
        initDataTable() {
            ...
            const options = {
                apiEndpoint: CountriesService.getUrl(),
                requestHeaders: {
